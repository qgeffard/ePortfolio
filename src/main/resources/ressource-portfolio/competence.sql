...
(1, 'A', 'Participation à un projet d''évolution d''un SI (Solution applicative et d''infrastructure portant prioritairement sur le domaine de spécialité du candidat)', 'Situation obligatoire', 0),
(2, 'B', 'Prise en charge d''incidents et de demandes d''assistance liés au domaine de spécialité du candidat', 'Situation obligatoire', 0),
(3, 'C', 'Elaboration de documents relatifs à la production et à la fourniture de services', 'Situation obligatoire', 0),
(4, 'D', 'Productions relatives à la mise en place d''un dispositif de veille technologique et à l''étude d''une technologie, d''un composant, d''un outil ou d''une méthode', 'Situation obligatoire', 0),
